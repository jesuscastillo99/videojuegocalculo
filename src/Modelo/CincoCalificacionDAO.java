...
public class CincoCalificacionDAO {
    ...
    public void actualizarEjercicio(int nControl, int intento, double calificacion){
        try{
            ...
            String query = "UPDATE cincocalificacion SET Intentos = ?, Calificacion = ? WHERE NoControl = ?";
    ...
    public int numeroControl(int nControl){
        try{
            ...
            ResultSet resultado = numero.executeQuery("SELECT NoControl FROM cincocalificacion WHERE NoControl = " + nControl);
    ...
    public int intento(int nControl){
        ...
        try{
            ...
            ResultSet resultado = oportunidades.executeQuery("SELECT Intentos FROM cincoCalificacion WHERE NoControl = " + nControl);
    ...
    public void agregar(int nControl, int intento, double calificacion){
        ...
        try{
            Connection accesoBD = conexion.establecerConexion();
            String query = "INSERT INTO cincoCalificacion VALUES (?, ?, ?)";
