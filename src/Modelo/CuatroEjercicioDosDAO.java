...
public class CuatroEjercicioDosDAO {
 ConexionBD conexion;
    int intentos;
    
    int control;
    
    public CuatroEjercicioDosDAO(){
    ...
    public void actualizarEjercicio(int nControl, int intento, double calificacion){
        try{
            ...
            String query = "UPDATE cuatroejerciciodos SET Intentos = ?, Calificacion = ? WHERE NoControl = ?";
    ...
    public int numeroControl(int nControl){
        try{
            ...
            ResultSet resultado = numero.executeQuery("SELECT NoControl FROM cuatroejerciciodos WHERE NoControl = " + nControl);
    ...
    public int intento(int nControl){
        ...
        try{
            ...
            ResultSet resultado = oportunidades.executeQuery("SELECT Intentos FROM cuatroejerciciodos WHERE NoControl = " + nControl);
    ...
    public void agregar(int nControl, int intento, double calificacion){
        ...
        try{
            Connection accesoBD = conexion.establecerConexion();
            String query = "INSERT INTO cuatroejerciciodos VALUES (?, ?, ?)";
