...
public class UnoEjercicioFinalDAO {
    
    ConexionBD conexion;
    int intentos;
    int control;
    
    public UnoEjercicioFinalDAO(){
    ...
    public void actualizarEjercicio(int nControl, int intento, double calificacion){
        try{
            ...
            String query = "UPDATE unoejerciciofinal SET Intentos = ?, Calificacion = ? WHERE NoControl = ?";
    ...
    public int numeroControl(int nControl){
        try{
            ...
            ResultSet resultado = numero.executeQuery("SELECT NoControl FROM unoejerciciofinal WHERE NoControl = " + nControl);
    ...
    public int intento(int nControl){
        ...
        try{
            ...
            ResultSet resultado = oportunidades.executeQuery("SELECT Intentos FROM unoejerciciofinal WHERE NoControl = " + nControl);
    ...
    public void agregar(int nControl, int intento, double calificacion){
        ...
        try{
            Connection accesoBD = conexion.establecerConexion();
            String query = "INSERT INTO unoejerciciofinal VALUES (?, ?, ?)";
    ...
    public void agregarCalificacionFinal(int nControl, double resultado){
        ...
        try{
            ...
            PreparedStatement prepared = accesoBD.prepareStatement(query);
            prepared.setInt(1, nControl);
            prepared.setDouble(2, resultado);
            prepared.execute();
